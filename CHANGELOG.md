...
* The grouping first tested `is_active`, which stays TRUE on an **ended** case role. On the 2026-09-21 clone **299 of 482** active coordinator rows are ended — 62%, some since March 2025. For the digest the consequence is a wrong email rather than a leak — a volunteer asked to confirm a project they handed over months ago — and it *hides* the real problem, because that project then never appears in the coordinator-less report the office works from.
...
* Unit suite **146 tests / 559 assertions** green on this branch (124/511 at P1-2's tip — the 22 tests and 48 assertions added here).
